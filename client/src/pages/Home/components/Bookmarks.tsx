...
const Bookmarks = () => {
  ...
  return (
    <Flex gap={20} py="md" className="w-full" wrap="wrap">
      <Link to="hello" className="no-underline">
        <Card
          shadow="sm"
          radius="md"
          withBorder
          className="lg:w-[295px] w-full"
        >
          <Card.Section>
            <Image
          ...
          <Text
            onClick={open}
            fz="xs"
            className="text-blue-500 hover:text-blue-600 hover:font-semibold cursor-pointer transition-all w-fit"
          >
            View More
          </Text>
        </Card>
      </Link>
      <Card shadow="sm" radius="md" withBorder className="lg:w-[295px] w-full">
        <Card.Section>
          <Image
      ...
      <BookmarkViewModal opened={opened} close={close} />
    </Flex>
  );
};
